...
.left[`r fa(name = "linkedin")` [Varsha](https://www.linkedin.com/in/varsha-ujjinni-vijay-kumar-1026121a4/) <br>`r fa(name = "envelope")` [vujj0001@student.monash.edu](mailto:vujj0001@student.monash.edu)]
---
class: inverse
...
table %>% DT::datatable(options = list(pageLength = 12, dom = 't'),width = '120%', height = '70%')
```
...
```{r dhs-facet, out.height="400px", eval=T}
knitr::include_graphics("images/dhs.PNG", dpi = NA) 
```

]
.panel[.panel-name[Code]

```{r facet, eval = F, echo = T}
